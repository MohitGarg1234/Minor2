...
const SendMails = ({currentUserEmailSend,targetUserEmailSend}) => {
    console.log(currentUserEmailSend);
    console.log(targetUserEmailSend);
  return (
    <div>
      <Link
        to={{
          pathname: "/message",
          state: {
            currentUserEmail: currentUserEmailSend,
            targetUserEmail: targetUserEmailSend,
          },
        }}
      >
