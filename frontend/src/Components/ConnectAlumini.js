...
const ConnectAlumini = () => {
  return (
    ...
    <div className="flex justify-center">
        <form className="m-4 w-9/12">
            <label htmlFor="search" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Grow your network</label>
            <div className="relative">
                ...
                <input type="search" id="search" className="block w-full p-4 pl-14 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Grow your network" required />
            </div>
        </form>
    </div>
