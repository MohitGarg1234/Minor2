      ...
      <div id="default-carousel" className="relative w-screen h-screen" data-carousel="slide">
        <div className="relative h-full overflow-hidden rounded-lg">
          <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src={Logo1} className="absolute inset-0 w-full h-full object-cover" alt="Slide 1"/>
          ...
          <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src={Logo2} className="absolute inset-0 w-full h-full object-cover" alt="Slide 2"/>
            <div className="absolute inset-0 flex items-center justify-center flex-col">
            <h1 className="text-white">Connect With Your Own Network</h1>
              <button className="btn">Login</button>
              <button className="btn">Signup</button>
          ...
          <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src={Logo3} className="absolute inset-0 w-full h-full object-cover" alt="Slide 3"/>
            <div className="absolute inset-0 flex items-center justify-center flex-col">
              <h1 className="text-white">Connect With Your Own Network</h1>
              <button className="btn">Login</button>
              <button className="btn">Signup</button>
          ...
          <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src={Logo4} className="absolute inset-0 w-full h-full object-cover" alt="Slide 4"/>
            <div className="absolute inset-0 flex items-center justify-center flex-col">
              <h1 className="text-white">Connect With Your Own Network</h1>
              <button className="btn">Login</button>
              <button className="btn">Signup</button>
          ...
          <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src={Logo5} className="absolute inset-0 w-full h-full object-cover" alt="Slide 5"/>
            <div className="absolute inset-0 flex items-center justify-center flex-col">
              <h1 className="text-white">Connect With Your Own Network</h1>
              <button className="btn">Login</button>
              <button className="btn">Signup</button>
