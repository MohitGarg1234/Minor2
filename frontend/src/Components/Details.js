  ...
  return (
    <section className="bg-gray-300">
      <div className="flex flex-col items-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="flex mt-2 items-center text-2xl font-semibold text-gray-900 dark:text-white">
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 md:space-y-6 sm:p-8">
            <div className="grid md:grid-cols-2 md:gap-4">
              <p className="w-full 5 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
...
className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 mb-4" id="file_input" type="file"/> */}
              <div className="grid md:grid-cols-2 md:gap-4">
                <div>
                  <label
                    htmlFor="name"
